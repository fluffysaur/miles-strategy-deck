...
export const HEYMAX_STEPS: HeyMaxStep[] = [
  {
    ...
    description: 'Before buying online vouchers, shopping on Shopee/Lazada/Klook, or booking hotels on Agoda/Trip.com, search the merchant on HeyMax.',
    icon: 'Search',
  ...
  },
  {
    ...
    description: 'Complete the transaction or voucher purchase using your specialized 4.0 MPD credit card.',
    icon: 'CreditCard',
  ...
  {
    step: 3,
    title: 'Step 3: Stack 4.0 MPD + Max Miles + Vouchers',
    description: 'Enjoy multi-layered stacking for up to 8.0 - 14.0 MPD total miles on the exact same dollar spent!',
    icon: 'Layers',
